...
/* SEI level */
#define X264_OPTS_NONE               0
#define X264_OPTS_INFO               1
#define X264_OPTS_FULL               2
...
#define X264_LEVEL_IDC_PSP          30 /* Actually the latest firmware supports Level 5.1, thus not restricted */
#define X264_LEVEL_IDC_PSV          31
