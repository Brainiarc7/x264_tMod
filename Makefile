...
common/oclobj.h: common/opencl/x264-cl.h $(wildcard common/opencl/*.cl)
...
OPT4 = --crf 22 -b3 -m7 -r4 --me esa -t2 -A all --psy-rd 1.0:1.0 --slices 4 --fgo 8 --fade-compensate 0.5 --weightp 3 --aq2-strength 0.5
